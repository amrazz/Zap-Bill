      ...
      <div className="max-w-sm w-full text-center space-y-8">
        ...
        <div className="pt-4">
          <Button 
            ...
            className="w-full h-12 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2"
          >
